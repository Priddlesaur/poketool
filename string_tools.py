def get_evolutions(chain_data):
    """
    Creates a list of Pokemon names in the evolution chain.
    :param chain_data: The evolution chain data.
    :return: A list of Pokemon names in the evolution chain.
    """
    ...
    # Return the list of Pokemon names in the evolution chain
    return output_chain

def format_evolution_chain(chain, highlight):
    """
    Creates a formatted string representing the evolution chain.
    :param chain: The list of Pokemon names in the evolution chain.
    :param highlight: The name of the Pokemon to highlight.
...
def snake_case_to_title(type_name):
    """
    Formats the Pokemon type name to be more readable.
